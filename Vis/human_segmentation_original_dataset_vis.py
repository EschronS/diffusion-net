...
class HumanSegOrigDataset(Dataset):
    ...
    def __init__(self, root_dir, k_eig=128):
        ...
        for iFile in range(1):
            ...
            print("loading mesh " + str(self.root_dir))

            verts, faces = pp3d.read_mesh(self.root_dir)
        ...
        self.frames_list, self.massvec_list, self.L_list, self.evals_list, self.evecs_list, self.gradX_list, self.gradY_list = diffusion_net.geometry.get_all_operators(self.verts_list, self.faces_list, k_eig=self.k_eig, op_cache_dir=None)
    ...
    def __call__(self):
        return self.verts_list[0], self.faces_list[0], self.frames_list[0], self.massvec_list[0], self.L_list[0], self.evals_list[0], self.evecs_list[0], self.gradX_list[0], self.gradY_list[0]
    def __getitem__(self, idx):
        return self.verts_list[idx], self.faces_list[idx], self.frames_list[idx], self.massvec_list[idx], self.L_list[idx], self.evals_list[idx], self.evecs_list[idx], self.gradX_list[idx], self.gradY_list[idx]